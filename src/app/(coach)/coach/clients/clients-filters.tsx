...
export type ClientsFilterId = 'todos' | 'riesgo' | 'naranja' | 'al_dia' | 'sin_plan'

const BASE_FILTER_ITEMS: FilterTabItem[] = [
  { id: 'todos',    label: 'Todos',     activeBackground: '#B5F23D', activeColor: '#0A0A0A' },
  { id: 'riesgo',   label: 'En riesgo', activeBackground: '#F25252', activeColor: '#0A0A0A' },
  { id: 'naranja',  label: 'Pendiente', activeBackground: '#F2C94A', activeColor: '#0A0A0A' },
